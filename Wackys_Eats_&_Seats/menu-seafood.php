    ...
    <body>
        ...
        <div class="main-menu">
            <div class="menu-title">
                <h1> Our Seafood Buffet </h1>
                <p> You can enjoy the dishes on our regular buffet plus all the seafood dishes </p>

                <nav class="navbar"> 
                    <a href="menu-regular.php"> Regular Buffet </a>
                    <a class="active" href="menu-seafood.php"> Seafood Buffet </a>
                </nav>
            ...
            <div class="row">
                <div class="menu-box">
                    <div class="menu-image">
                        <img src="images/Pusit.jpg" alt="Pusit">
                    </div>
                    
                    <div class="menu-content">
                        <h5> Pusit </h5>
                        <p> Squid dish cooked using the popular Filipino adobo method </p>
                ...
                <div class="menu-box">
                    ...
                    <div class="menu-content">
                        <h5> Paksiw </h5>
                        <p> Paksiw na Isda or Fish Cooked in Vinegar </p>
                        <span class="type"> Seafood </span>
                    </div>
                </div>
                ...
                <div class="menu-box">
                    ...
                    <div class="menu-content">
                        <h5> Shrimp </h5>
                        <p> Shrimp cooked in a sweet and savory sauce </p>
                        <span class="type"> Seafood </span>
                    </div>
                </div>
                ...
                <div class="menu-box">
                    ...
                    <div class="menu-content">
                        <h5> Crablets </h5>
                        <p> Seasoned small crabs that were dredged in cornstarch and deep-fried until crispy </p>
                        <span class="type"> Seafood </span>
                    </div>
                </div>
                ...
                <div class="menu-box">
                    ...
                    <div class="menu-content">
                        <h5> Boiled Crabs </h5>
                        <p> Boiling crab in salted water </p>
                        <span class="type"> Seafood </span>
                    </div>
                </div>
                ...
                <div class="menu-box">
                    ...
                    <div class="menu-content">
                        <h5> Mixed Seafoods </h5>
                        <p> Combination of different seafoods </p>
                        <span class="type"> Seafood </span>
                    </div>
                </div>
                ...
                <div class="menu-box">
                    <div class="menu-image">
                        <img src="images/Crabs.jpg" alt="Crabs">
                    </div>
